...
%Add what the average counts per second for B was and discuss the rate% and why we just leave it as b or c not b and/or c
...
%how many channels did we have? 2000 something?
\end{center}
\end{table}
